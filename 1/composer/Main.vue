  ...
  <div class="notation-container">
    ...
    <div class="control-deck">
        ...
        <div class="loop-control-sub">
          <label class="loop-toggle-label">
            ...
            <span class="loop-toggle-text" :class="{ 'loop-on': isLoopEnabled }">
              {{ isLoopEnabled ? 'Looping Enabled' : 'Looping Disabled' }}
            </span>
          </label>
        </div>
      </div>
      ...
      <div class="audio-control-row">
        <button class="btn btn-audio" @click="backMeasure" title="Back 1 Measure">Back Measure</button>
        <button class="btn btn-audio" @click="rewindScore" title="Rewind to Beginning">Rewind</button>
        ...
        <button class="btn btn-audio" @click="forwardMeasure" title="Forward 1 Measure">Next Measure</button>
      </div>
    </div>
  </div>
</template>
...
import VexFlow from './lib/vexflow.js';
import { ScorePlayer } from './lib/play.js';
import { MicrophoneController } from './lib/microphone_control.js';
import { generateMeasure } from './lib/generate.js';
